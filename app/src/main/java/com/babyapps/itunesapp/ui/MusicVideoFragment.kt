...
import com.babyapps.itunesapp.databinding.FragmentMusicvideoBinding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class MusicVideoFragment : Fragment(R.layout.fragment_musicvideo),
    ITunesPagingAdapter.OnItemClickListener {
    private lateinit var binding: FragmentMusicvideoBinding
    private val viewModel: ITunesViewModel by viewModels()
    private lateinit var itunesAdapter: ITunesPagingAdapter
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        binding = FragmentMusicvideoBinding.bind(view)
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            override fun onQueryTextSubmit(query: String?): Boolean {
                if (query != null) {
                    ...
                    viewModel.searchMusicVideo(query)
    ...
    private fun subscribeObservers() {
        viewModel.musicVideos.observe(viewLifecycleOwner, Observer {
