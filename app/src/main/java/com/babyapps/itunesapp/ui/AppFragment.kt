...
import com.babyapps.itunesapp.databinding.FragmentAppBinding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class AppFragment : Fragment(R.layout.fragment_app),ITunesPagingAdapter.OnItemClickListener {
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            override fun onQueryTextSubmit(query: String?): Boolean {
                if (query != null) {
                    ...
                    viewModel.searchApplication(query)
    ...
    private fun subscribeObservers(){
        viewModel.applications.observe(viewLifecycleOwner, Observer {
